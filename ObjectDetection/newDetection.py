...
# Define VideoStream class to handle streaming of video from pi camera in separate processing thread
...
try:
    while True:
        ...
        if not frame_queue.empty():
            ...
            print(f"Object: {object_name}, Top Left: {top_left}, Top Right: {top_right}, Bottom Left: {bottom_left}, Bottom Right: {bottom_right}")
